...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`MasterStats` (`LogID`, `Steam64ID`, `Class`, `MapID`, `Kills`, `Assists`, `Deaths`, `Damage`, `Damage Taken`, `SecondsPlayed`) VALUES (2719534, 76561198034955422, 'Sniper', '2', 19, 1, 12, 7256, 3308, 854);
INSERT INTO `mydb`.`MasterStats` (`LogID`, `Steam64ID`, `Class`, `MapID`, `Kills`, `Assists`, `Deaths`, `Damage`, `Damage Taken`, `SecondsPlayed`) VALUES (2719534, 76561198068104187, 'Demo', '2', 13, 7, 13, 6589, 7421, 854);
INSERT INTO `mydb`.`MasterStats` (`LogID`, `Steam64ID`, `Class`, `MapID`, `Kills`, `Assists`, `Deaths`, `Damage`, `Damage Taken`, `SecondsPlayed`) VALUES (2719534, 76561198028658527, 'Scout', '2', 9, 3, 12, 3387, 3935, 854);
INSERT INTO `mydb`.`MasterStats` (`LogID`, `Steam64ID`, `Class`, `MapID`, `Kills`, `Assists`, `Deaths`, `Damage`, `Damage Taken`, `SecondsPlayed`) VALUES (2759736, 76561198123721061, 'Spy', '6', 3, 3, 9, 1238, 1627, 775);
INSERT INTO `mydb`.`MasterStats` (`LogID`, `Steam64ID`, `Class`, `MapID`, `Kills`, `Assists`, `Deaths`, `Damage`, `Damage Taken`, `SecondsPlayed`) VALUES (2759736, 76561198059227222, 'Heavy', '6', 6, 2, 7, 2097, 4394, 775);
INSERT INTO `mydb`.`MasterStats` (`LogID`, `Steam64ID`, `Class`, `MapID`, `Kills`, `Assists`, `Deaths`, `Damage`, `Damage Taken`, `SecondsPlayed`) VALUES (2759736, 76561198034955422, 'Sniper', '6', 9, 2, 5, 2632, 2741, 775);
INSERT INTO `mydb`.`MasterStats` (`LogID`, `Steam64ID`, `Class`, `MapID`, `Kills`, `Assists`, `Deaths`, `Damage`, `Damage Taken`, `SecondsPlayed`) VALUES (2759736, 76561198068104187, 'Demo', '6', 19, 1, 6, 7540, 4990, 775);
